...
game.prototype.transitionStates["A"] = 3; //A Turn
game.prototype.transitionStates["B"] = 4; //B Turn
game.prototype.transitionStates["AWin"] = 5; //A won
game.prototype.transitionStates["BWin"] = 6; //B won
game.prototype.transitionStates["Draw"] = 7; //Draw
game.prototype.transitionStates["ABORTED"] = 8; //game cancelled
...
game.prototype.transitionMatrix = [
    ...
    [0, 0, 0, 1, 1, 0, 0, 0, 1],   //2 JOINT (note: once we have two players, there is no way back!)
    [0, 0, 0, 0, 1, 1, 1, 1, 1],   //A turn
    [0, 0, 0, 1, 0, 1, 1, 1, 1],   //B turn
    [0, 0, 0, 0, 0, 0, 0, 0, 0],   //A won
    [0, 0, 0, 0, 0, 0, 0, 0, 0],   //B won
    [0, 0, 0, 0, 0, 0, 0, 0, 0],   //Draw
    [0, 0, 0, 0, 0, 0, 0, 0, 0],   //game cancelled
];
